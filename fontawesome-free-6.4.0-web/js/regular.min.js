...
! function () {
    ...
    var l = (c.navigator || {}).userAgent,
        ...
        a = c,
        H = s;
    a.document, H.documentElement && H.head && "function" == typeof H.addEventListener && H.createElement, ~z.indexOf("MSIE") || z.indexOf("Trident/");
    ...
    a = a || {};
    a[f] || (a[f] = {}), a[f].styles || (a[f].styles = {}), a[f].hooks || (a[f].hooks = {}), a[f].shims || (a[f].shims = []);
    var v = a[f];
    ...
    function u(c, s, l) {
        var z = (2 < arguments.length && void 0 !== l ? l : {}).skipHooks,
            l = void 0 !== z && z,
            z = d(s);
        "function" != typeof v.hooks.addPack || l ? v.styles[c] = e(e({}, v.styles[c] || {}), z) : v.hooks.addPack(c, d(s)), "fas" === c && u("fa", s)
    }
    var g = {
