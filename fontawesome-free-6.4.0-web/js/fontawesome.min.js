...
! function () {
        ...
        J.autoAddCss && !ct && (function (t) {
            if (t && y) {
                ...
                for (var e = h.head.childNodes, n = null, i = e.length - 1; - 1 < i; i--) {
                    var r = e[i],
                        o = (r.tagName || "").toUpperCase(); - 1 < ["STYLE", "LINK"].indexOf(o) && (n = r)
                }
    ...
    function It() {
        ...
        St = a.names, jt = a.unicodes, Nt = Dt(J.styleDefault, {
    ...
    var oa = J.measurePerformance && d && d.mark && d.measure ? d : {
        ...
        ca = {
            begin: function (t) {
                return oa.mark("".concat(sa, " ").concat(t, " begins")),
                    function () {
                        return ra(t)
                    }
            },
    ...
    function wa(t) {
        var a = t.getAttribute("data-prefix"),
            ...
            i = Ht(nt(t));
        return i.prefix || (i.prefix = Nt), a && e && (i.prefix = a, i.iconName = e), i.iconName && i.prefix || (i.prefix && 0 < n.length && (i.iconName = (e = i.prefix, n = t.innerText, (Ct[e] || {})[n] || Lt(i.prefix, yt(t.innerText)))), !i.iconName && J.autoFetchSvg && t.firstChild && t.firstChild.nodeType === Node.TEXT_NODE && (i.iconName = t.firstChild.data)), i
    }
    ...
    function za(b, p) {
        ...
        return new Promise(function (e, t) {
            ...
            var n, i, r, o, a, s, c, f = et(b.children).filter(function (t) {
            ...
            u && "none" !== d && "" !== d ? (s = l.getPropertyValue("content"), a = ~["Sharp"].indexOf(u[2]) ? L : I, n = ~["Solid", "Regular", "Light", "Thin", "Duotone", "Brands", "Kit"].indexOf(u[2]) ? D[a][u[2].toLowerCase()] : X[a][m], d = (l = (l = (d = s).replace(ja, ""), a = 0, s = (m = l).length, c = 55296 <= (d = m.charCodeAt(a)) && d <= 56319 && a + 1 < s && 56320 <= (c = m.charCodeAt(a + 1)) && c <= 57343 ? 1024 * (d - 55296) + c - 56320 + 65536 : d, d = Ea[0] <= c && c <= Ea[1], {
                ...
                prefix: null,
                iconName: null
            }).iconName && l.prefix && (u = l.iconName, n = l.prefix)), !u || c || f && f.getAttribute(C) === n && f.getAttribute(S) === i ? e() : (b.setAttribute(v, i), f && b.removeChild(f), (o = (r = {
                iconName: null,
                title: null,
                titleId: null,
                prefix: null,
